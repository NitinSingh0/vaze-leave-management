    ...
    <div id="teaching-section" class="mt-6">
        <div class="flex space-x-4 mb-4">
            ...
            <div class="dark:text-black">
                ...
                <select id="teaching_type" class=" text-gray-900 w-full border border-gray-300 p-2 rounded-lg focus:border-blue-400" onchange="change1(this)">
            ...
            <div class="dark:text-black">
                ...
                <select id="teaching_department" class="w-full text-gray-900 border border-gray-300 p-2 rounded-lg focus:border-blue-400">
        ...
        <div>
            <button type="button" id="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 " onclick="table1()">Show</button>
        </div>
        <br>
        <!-- Table -->
        <div id="teaching-table" class="hidden overflow-x-auto">
            <table class="w-full bg-white rounded-lg shadow-lg">
                ...
                <tbody id="teaching-staff-list" class=" text-gray-800"></tbody>
            </table>
        </div>
    ...
    <div id="nonteaching-section" class="mt-6 hidden">
        <div class="flex space-x-4 mb-4">
            ...
            <div>
                ...
                <select id="nonteaching-department" class="text-gray-800 w-full border border-gray-300 p-2 rounded-lg focus:border-blue-400">
        ...
        <div>
            <button type="button" id="submit2" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 " onclick="table2()">Show</button>
        </div>
        <br>
        <!-- Table -->
        <div id="nonteaching-table" class="hidden overflow-x-auto">
            <table class="w-full bg-white rounded-lg shadow-lg">
                ...
                <tbody id="nonteaching-staff-list" class=" text-gray-800"></tbody>
            </table>
        </div>
    </div>
</div>
